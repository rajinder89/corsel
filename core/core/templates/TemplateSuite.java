...
public class TemplateSuite {
	...
	public void testMyRegressionSuite(){
		...
		Class<?>[]  lcScripts = {
				...
				TemplateScript.class,	//Example 1st script name with ".class" extension to run in suite
				TemplateScript.class	//Example 2nd script name with ".class" extension to run in suite
		};
